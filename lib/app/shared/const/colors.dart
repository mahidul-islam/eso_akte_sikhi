...
class SGColors {
  ...
  static const Color violet = Color(0xff711DB0);
  static const Color orange = Color(0xffFF9843);
  static const Color yellow = Color(0xffFFDD95);
  static const Color reddish = Color(0xffFF3838);
  static const Color lightReddish = Color(0xffFFB8B8);
